...
ninja.data = [
  ...
  {%- for collection in site.collections -%}
    {%- if collection.label != 'posts' -%}
      ...
      {%- if collection.label == 'news' and site.news_in_search == false -%}
        {%- assign include_collection = false -%}
      {%- endif -%}
      {%- if collection.label == 'projects' and site.projects_in_search == false -%}
        {%- assign include_collection = false -%}
      {%- endif -%}
      {%- if collection.label == 'books' and site.books_in_search == false -%}
        {%- assign include_collection = false -%}
      {%- endif -%}
